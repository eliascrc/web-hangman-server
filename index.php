...
if (isset($_GET['wsdl'])) {
	...
	//Para evitar la excepci�n por defecto de SOAP PHP cuando no existe HTTP_RAW_POST_DATA,
	//se regresa expl�citamente el siguiente fallo cuando no hay solicitud (v.b. desde un navegador)
  /*
